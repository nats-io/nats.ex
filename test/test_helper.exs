      ...
      {:error, reason} ->
        Mix.raise(
          "Cannot connect to gnatsd" <>
            ...
            "the following command `gnatsd -p 4223 " <> "--user bob --pass alice`."
        )
    end
      ...
      {:error, reason} ->
        Mix.raise(
          "Cannot connect to gnatsd" <>
            ...
            "--tls --tlscert test/fixtures/server.pem " <> "--tlskey test/fixtures/key.pem`."
        )
    end
      ...
      {:error, reason} ->
        Mix.raise(
          "Cannot connect to gnatsd" <>
            ...
            "--tlskey test/fixtures/key.pem " <> "--tlscacert test/fixtures/ca.pem --tlsverify"
        )
    end
  end
